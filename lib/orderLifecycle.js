...
const CANCELLABLE_STATUSES = ["Pending", "Pending Payment", "Confirmed", "Inventory Reserved"];
...
export async function createOnlineOrder({
  ...
  const shippingDetails = {
    ...
    landmark: normalizeText(customerDetails?.landmark),
  };
