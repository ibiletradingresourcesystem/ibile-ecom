...
export function buildPasswordResetEmail({ name, resetUrl, expiresInMinutes }) {
  ...
  // Mail clients block remote images by default and none of them render SVG,
  // so the header is a styled wordmark that always shows, with the raster logo
  // above it for the clients that do load images.
